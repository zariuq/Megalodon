...
assume HC1 HC2 HC3 HC4 HC5 HC6 HC7 HC8 HC9 HC10 HC11 HC12 HC13 HC14 HC15 HC16 HC17 HC18 HC19 HC20 HC21 HC22 HC23 HC24 HC25 HC26 HC27 HC28 HC29 HC30 HC31 HC32 HC33 HC34 HC35 HC36 HC37 HC38 HC39 HC40 HC41 HC42 HC43 HC44 HC45.
(** Idea: select out the clauses with ?? I want and then use them below. **)
...
{ exact ??. }
claim LZ1clause1: forall X3 X1 X2, (empty X2 -> False) -> (misses X3 X2 -> False) -> (mem X1 (esk10_1 X2) -> False) -> mem X3 X1 -> mem X1 (Un X2) -> False.
{ exact ??. }
claim LZ1clause2: forall X1 X2, (empty X2 -> False) -> (mem X1 (Un X2) -> False) -> mem X1 (esk10_1 X2) -> False.
{ exact ??. }
claim LZ1clause3: forall X2 X1, (empty X1 -> False) -> (mem (esk11_2 X1 X2) X2 -> False) -> mem X2 (esk10_1 X1) -> False.
{ exact ??. }
claim LZ1clause4: forall X2 X1, (empty X1 -> False) -> mem X2 (esk10_1 X1) -> misses (esk11_2 X1 X2) X1 -> False.
{ exact ??. }
claim LZ2clause1: forall X1 X2, (empty X2 -> False) -> (misses X1 X2 -> False) -> (mem X1 (esk12_1 X2) -> False) -> mem X1 (Un (Un X2)) -> False.
{ exact ??. }
claim LZ2clause2: forall X1 X2, (empty X2 -> False) -> (mem X1 (Un (Un X2)) -> False) -> mem X1 (esk12_1 X2) -> False.
{ exact ??. }
claim LZ2clause3: forall X1 X2, (empty X2 -> False) -> misses X1 X2 -> mem X1 (esk12_1 X2) -> False.
{ exact ??. }
claim LXne: empty esk1_0 -> False.
{ exact ??. }
claim LY_clause1: forall X1, (empty X1 -> False) -> (mem (esk13_1 X1) X1 -> False) -> False.
{ exact ??. }
claim LY_clause2: forall X1, (empty X1 -> False) -> (misses (esk13_1 X1) X1 -> False) -> False.
{ exact ??. }
...
{ exact ??. }
claim L_cc_memX: forall X1, (mem (esk3_1 X1) X1 -> False) -> mem X1 esk1_0 -> False.
{ exact ??. }
claim L_cc_mem2: forall X1, (mem (esk2_1 X1) (esk3_1 X1) -> False) -> mem X1 esk1_0 -> False.
{ exact ??. }
...
{ let Y y.
  ...
  assume H4: mem Y Z1 -> False.
  exact LZ1clause1 y Y X LXne H3 H4 H2 H1.
}
claim LZ1E: forall Y, mem Y Z1 -> (mem Y (Un X) -> forall y, mem y Y -> (misses y X -> False) -> False) -> False.
{ let Y.
  assume H1: mem Y Z1.
  assume H2: mem Y (Un X) -> forall y, mem y Y -> (misses y X -> False) -> False.
  apply (fun H: mem Y (Un X) -> False => LZ1clause2 Y X LXne H H1).
  assume H3: mem Y (Un X).
  apply (fun H: mem (esk11_2 X Y) Y -> False => LZ1clause3 Y X LXne H H1).
  assume H4: mem (esk11_2 X Y) Y.
  apply H2 H3 (esk11_2 X Y) H4.
  assume H5: misses (esk11_2 X Y) X.
  exact LZ1clause4 Y X LXne H1 H5.
}
claim LZ2I: forall Y, mem Y (Un (Un X)) -> (misses Y X -> False) -> (mem Y Z2 -> False) -> False.
{ let Y.
  assume H1: mem Y (Un (Un X)).
  assume H2: misses Y X -> False.
  assume H3: mem Y Z2 -> False.
  exact LZ2clause1 Y X LXne H2 H3 H1.
}
claim LZ2E: forall Y, mem Y Z2 -> (mem Y (Un (Un X)) -> (misses Y X -> False) -> False) -> False.
{ let Y.
  assume H1: mem Y Z2.
  assume H2: mem Y (Un (Un X)) -> (misses Y X -> False) -> False.
  apply (fun H:mem Y (Un (Un X)) -> False => LZ2clause2 Y X LXne H H1).
  assume H3: mem Y (Un (Un X)).
  apply H2 H3.
  assume H4: misses Y X.
  exact LZ2clause3 Y X LXne H4 H1.
}
set W := bun (bun X Z1) Z2.
set Y := esk13_1 W.
claim LW: empty W -> False.
{ assume H1: empty (bun (bun X Z1) Z2).
  apply (fun H: empty (bun X Z1) -> False => L_bun_empty_clause Z2 (bun X Z1) H H1).
  assume H2: empty (bun X Z1).
  exact L_bun_empty_clause Z1 X LXne H2.
}
apply LY_clause1 W LW.
assume HYW1: mem Y W.
apply LY_clause2 W LW.
assume HYW2: misses Y W.
apply (fun H:misses Y (bun X Z1) -> False => L_misses_bun_clause1 Z2 Y (bun X Z1) H HYW2).
...
apply (fun H:misses Y Z2 -> False => L_misses_bun_clause2 (bun X Z1) Y Z2 H HYW2).
assume HYZ2: misses Y Z2.
apply LbunE (bun X Z1) Z2 Y HYW1.
- assume H1: mem Y (bun X Z1).
  apply LbunE X Z1 Y H1.
  + assume H1: mem Y X.
    apply (fun H:mem (esk3_1 Y) Y -> False => L_cc_memX Y H H1).
    assume H2: mem (esk3_1 Y) Y.
    apply (fun H:mem (esk2_1 Y) (esk3_1 Y) -> False => L_cc_mem2 Y H H1).
    assume H3: mem (esk2_1 Y) (esk3_1 Y).
    apply LUnI X (esk3_1 Y) Y H1 H2.
    assume H4: mem (esk3_1 Y) (Un X).
    apply LZ1I (esk3_1 Y) (esk2_1 Y) H4 H3 (L_cc_misses Y H1).
    assume H5: mem (esk3_1 Y) Z1.
    exact LmissesEclause Y (esk3_1 Y) Z1 H5 H2 HYZ1.
  + assume H1: mem Y Z1.
    apply LZ1E Y H1.
    assume H2: mem Y (Un X).
    let y.
    assume H3: mem y Y.
    assume H4: misses y X -> False.
    apply LUnI (Un X) y Y H2 H3.
    assume H5: mem y (Un (Un X)).
    apply LZ2I y H5 H4.
    assume H6: mem y Z2.
    exact LmissesEclause Y y Z2 H6 H3 HYZ2.
- assume H1: mem Y Z2.
  apply LZ2E Y H1.
...
Theorem t4_xregular:
 ...
 forall k2_xboole_0:set -> set -> set,
  ...
  -> ((v1_xboole_0 k1_xboole_0 -> False) -> False)
  -> False.
let Un esk7_2 esk11_1 esk8_2 esk15_2 esk4_1 esk3_1 esk17_1 esk10_0 esk9_0 emptyset esk2_1 esk1_0 esk18_2 esk13_2 esk12_2 esk14_1 misses esk16_1 empty esk6_3 mem esk5_3 bun.
assume HC1 HC2 HC3 HC4 HC5 HC6 HC7 HC8 HC9 HC10 HC11 HC12 HC13 HC14 HC15 HC16 HC17 HC18 HC19 HC20 HC21 HC22 HC23 HC24 HC25 HC26 HC27 HC28 HC29 HC30 HC31 HC32 HC33 HC34 HC35 HC36 HC37 HC38 HC39 HC40 HC41 HC42 HC43 HC44 HC45 HC46 HC47 HC48 HC49 HC50 HC51.
claim LbunI1clause: forall X2 X4 X1 X3, (mem X1 X3 -> False) -> X3 = (bun X2 X4) -> mem X1 X2 -> False.
{ exact ??. }
claim LbunI2clause: forall X2 X4 X1 X3, (mem X1 X3 -> False) -> X3 = (bun X4 X2) -> mem X1 X2 -> False.
{ exact ??. }
...
{ exact ??. }
set Z1skol := esk11_1.
claim LZ1clause1: forall X3 X4 X1 X2, (empty X2 -> False) -> (misses X3 X2 -> False) -> (mem X1 (Z1skol X2) -> False) -> mem X4 X1 -> mem X3 X4 -> mem X1 (Un X2) -> False.
{ exact ??. }
claim LZ1clause2: forall X2 X1, (empty X1 -> False) -> (mem (esk12_2 X1 X2) (esk13_2 X1 X2) -> False) -> mem X2 (Z1skol X1) -> False.
{ exact ??. }
claim LZ1clause3: forall X2 X1, (empty X1 -> False) -> mem X2 (Z1skol X1) -> misses (esk12_2 X1 X2) X1 -> False.
{ exact ??. }
claim LZ1clause4: forall X2 X1, (empty X1 -> False) -> (mem (esk13_2 X1 X2) X2 -> False) -> mem X2 (Z1skol X1) -> False.
{ exact ??. }
claim LZ1clause5: forall X1 X2, (empty X2 -> False) -> (mem X1 (Un X2) -> False) -> mem X1 (Z1skol X2) -> False.
{ exact ??. }
set Z2skol := esk14_1.
claim LZ2clause1: forall X3 X1 X2, (empty X2 -> False) -> (misses X3 X2 -> False) -> (mem X1 (Z2skol X2) -> False) -> mem X3 X1 -> mem X1 (Un (Un X2)) -> False.
{ exact ??. }
claim LZ2clause2: forall X2 X1, (empty X1 -> False) -> mem X2 (Z2skol X1) -> misses (esk15_2 X1 X2) X1 -> False.
{ exact ??. }
claim LZ2clause3: forall X2 X1, (empty X1 -> False) -> (mem (esk15_2 X1 X2) X2 -> False) -> mem X2 (Z2skol X1) -> False.
{ exact ??. }
claim LZ2clause4: forall X1 X2, (empty X2 -> False) -> (mem X1 (Un (Un X2)) -> False) -> mem X1 (Z2skol X2) -> False.
{ exact ??. }
set Z3skol := esk16_1.
claim LZ3clause1: forall X1 X2, (empty X2 -> False) -> (misses X1 X2 -> False) -> (mem X1 (Z3skol X2) -> False) -> mem X1 (Un (Un (Un X2))) -> False.
{ exact ??. }
claim LZ3clause2: forall X1 X2, (empty X2 -> False) -> (mem X1 (Un (Un (Un X2))) -> False) -> mem X1 (Z3skol X2) -> False.
{ exact ??. }
claim LZ3clause3: forall X1 X2, (empty X2 -> False) -> misses X1 X2 -> mem X1 (Z3skol X2) -> False.
{ exact ??. }
claim LXne: empty esk1_0 -> False.
{ exact ??. }
set Yskol := esk17_1.
...
claim L_cc_misses: forall X1, mem X1 esk1_0 -> misses (esk2_1 X1) esk1_0 -> False.
{ exact ??. }
claim L_cc_memX: forall X1, (mem (esk4_1 X1) X1 -> False) -> mem X1 esk1_0 -> False.
{ exact ??. }
claim L_cc_mem2: forall X1, (mem (esk3_1 X1) (esk4_1 X1) -> False) -> mem X1 esk1_0 -> False.
{ exact ??. }
claim L_cc_mem3: forall X1, (mem (esk2_1 X1) (esk3_1 X1) -> False) -> mem X1 esk1_0 -> False.
{ exact ??. }
claim LbunI1: forall X Y Z, mem Z X -> (mem Z (bun X Y) -> False) -> False.
{ let X Y Z.
  assume G1: mem Z X.
...
set Z2 := Z2skol X.
set Z3 := Z3skol X.
claim LZ1I: forall Y U V, mem Y (Un X) -> mem V Y -> mem U V -> (misses U X -> False) -> (mem Y Z1 -> False) -> False.
{ let Y U V.
  assume H1: mem Y (Un X).
  assume H2: mem V Y.
  assume H3: mem U V.
  ...
  exact LZ1clause1 U V Y X LXne ?? ?? ?? ?? ??.
}
claim LZ1E: forall Y, mem Y Z1 -> (mem Y (Un X) -> forall u v, mem v Y -> mem u v -> (misses u X -> False) -> False) -> False.
{ let Y.
  assume H1: mem Y Z1.
  assume H2: mem Y (Un X) -> forall u v, mem v Y -> mem u v -> (misses u X -> False) -> False.
  apply (fun H: mem Y (Un X) -> False => LZ1clause5 Y X LXne H H1).
  assume H3: mem Y (Un X).
  apply (fun H: mem (esk13_2 X Y) Y -> False => LZ1clause4 Y X LXne H H1).
  assume H4: mem (esk13_2 X Y) Y.
  apply (fun H: mem (esk12_2 X Y) (esk13_2 X Y) -> False => LZ1clause2 Y X LXne H H1).
  assume H5: mem (esk12_2 X Y) (esk13_2 X Y).
  apply H2 H3 (esk12_2 X Y) (esk13_2 X Y) H4 H5.
  assume H6: misses (esk12_2 X Y) X.
  exact LZ1clause3 Y X LXne H1 H6.
}
claim LZ2I: forall Y y, mem Y (Un (Un X)) -> mem y Y -> (misses y X -> False) -> (mem Y Z2 -> False) -> False.
{ let Y y.
  assume H1: mem Y (Un (Un X)).
  assume H2: mem y Y.
  assume H3: misses y X -> False.
  assume H4: mem Y Z2 -> False.
  exact LZ2clause1 y Y X LXne H3 H4 H2 H1.
}
claim LZ2E: forall Y, mem Y Z2 -> (mem Y (Un (Un X)) -> forall y, mem y Y -> (misses y X -> False) -> False) -> False.
{ let Y.
  assume H1: mem Y Z2.
  assume H2: mem Y (Un (Un X)) -> forall y, mem y Y -> (misses y X -> False) -> False.
  apply (fun H: mem Y (Un (Un X)) -> False => LZ2clause4 Y X LXne H H1).
  assume H3: mem Y (Un (Un X)).
  apply (fun H: mem (esk15_2 X Y) Y -> False => LZ2clause3 Y X LXne H H1).
  assume H4: mem (esk15_2 X Y) Y.
  apply H2 H3 (esk15_2 X Y) H4.
  assume H5: misses (esk15_2 X Y) X.
  exact LZ2clause2 Y X LXne H1 H5.
}
claim LZ3I: forall Y, mem Y (Un (Un (Un X))) -> (misses Y X -> False) -> (mem Y Z3 -> False) -> False.
{ let Y.
  assume H1: mem Y (Un (Un (Un X))).
  assume H2: misses Y X -> False.
  assume H3: mem Y Z3 -> False.
  exact LZ3clause1 Y X LXne H2 H3 H1.
}
claim LZ3E: forall Y, mem Y Z3 -> (mem Y (Un (Un (Un X))) -> (misses Y X -> False) -> False) -> False.
{ let Y.
  assume H1: mem Y Z3.
  assume H2: mem Y (Un (Un (Un X))) -> (misses Y X -> False) -> False.
  apply (fun H:mem Y (Un (Un (Un X))) -> False => LZ3clause2 Y X LXne H H1).
  assume H3: mem Y (Un (Un (Un X))).
  apply H2 H3.
  assume H4: misses Y X.
  exact LZ3clause3 Y X LXne H4 H1.
}
set W := bun (bun (bun X Z1) Z2) Z3.
set Y := Yskol W.
claim LW: empty W -> False.
{ assume H1: empty (bun (bun (bun X Z1) Z2) Z3).
  apply (fun H: empty (bun (bun X Z1) Z2) -> False => L_bun_empty_clause Z3 (bun (bun X Z1) Z2) H H1).
  assume H2: empty (bun (bun X Z1) Z2).
  apply (fun H: empty (bun X Z1) -> False => L_bun_empty_clause Z2 (bun X Z1) H H2).
  assume H3: empty (bun X Z1).
  exact L_bun_empty_clause Z1 X LXne H3.
}
apply LY_clause1 W LW.
assume HYW1: mem Y W.
apply LY_clause2 W LW.
assume HYW2: misses Y W.
apply (fun H:misses Y (bun (bun X Z1) Z2) -> False => L_misses_bun_clause1 Z3 Y (bun (bun X Z1) Z2) H HYW2).
...
assume HYZ2: misses Y Z2.
apply (fun H:misses Y Z3 -> False => L_misses_bun_clause2 (bun (bun X Z1) Z2) Y Z3 H HYW2).
assume HYZ3: misses Y Z3.
apply LbunE (bun (bun X Z1) Z2) Z3 Y HYW1.
- assume H1: mem Y (bun (bun X Z1) Z2).
  apply LbunE (bun X Z1) Z2 Y H1.
  + assume H1: mem Y (bun X Z1).
    apply LbunE X Z1 Y H1.
    * assume H1: mem Y X.
      apply (fun H:mem (esk4_1 Y) Y -> False => L_cc_memX Y H H1).
      assume H2: mem (esk4_1 Y) Y.
      apply (fun H:mem (esk3_1 Y) (esk4_1 Y) -> False => L_cc_mem2 Y H H1).
      assume H3: mem (esk3_1 Y) (esk4_1 Y).
      apply (fun H:mem (esk2_1 Y) (esk3_1 Y) -> False => L_cc_mem3 Y H H1).
      assume H4: mem (esk2_1 Y) (esk3_1 Y).
      apply LUnI X (esk4_1 Y) Y H1 H2.
      assume H5: mem (esk4_1 Y) (Un X).
      apply LZ1I (esk4_1 Y) (esk2_1 Y) (esk3_1 Y) H5 H3 H4 (L_cc_misses Y H1).
      assume H6: mem (esk4_1 Y) Z1.
      exact LmissesEclause Y (esk4_1 Y) Z1 H6 H2 HYZ1.
    * assume H1: mem Y Z1.
      apply LZ1E Y H1.
      assume H2: mem Y (Un X).
      let u v.
      ...
      apply LUnI (Un X) v Y H2 Hv.
      assume H4: mem v (Un (Un X)).
      apply LZ2I v u H4 Hu H3.
      assume H5: mem v Z2.
      exact LmissesEclause Y v Z2 H5 Hv HYZ2.
  + assume H1: mem Y Z2.
    apply LZ2E Y H1.
    assume HY: mem Y (Un (Un X)).
    let y.
    assume Hy: mem y Y.
    assume H2: misses y X -> False.
    apply LUnI (Un (Un X)) y Y HY Hy.
    assume H3: mem y (Un (Un (Un X))).
    apply LZ3I y H3 H2.
    assume H4: mem y Z3.
    exact LmissesEclause Y y Z3 H4 Hy HYZ3.
- assume H1: mem Y Z3.
  apply LZ3E Y H1.
  assume H2: mem Y (Un (Un (Un X))).
  assume H3: misses Y X -> False.
  exact H3 HYX.
Qed.
